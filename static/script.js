...
import disabledButton from "./Socket/components/disabledButton.js";
...
PAPB.addEventListener("click", () => {
    PAPB.disabled = true;
    SocketPost(socket, "parse_all"); 
});  
let PADPB = document.querySelector("#parse-all-delivery-prices-button");
PADPB.addEventListener("click", () => {
    PADPB.disabled = true;
    SocketPost(socket, "delivery_all_parse"); 
});
